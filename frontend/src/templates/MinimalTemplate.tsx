...
//     <div
//       id="resume-template"
//       className="w-[210mm] h-[297mm] bg-white p-16 font-serif text-center mx-auto shadow-sm overflow-hidden box-border print:overflow-visible print:h-auto print:min-h-[297mm]"
//     >
//       {/* HEADER */}
...
export default function MinimalTemplate({ data }: { data: ResumeData }) {
  return (
    <div
      id="resume-template"
      className="w-[210mm] h-[297mm] bg-white p-16 font-serif text-center mx-auto shadow-sm overflow-hidden box-border"
    >
      {/* HEADER */}
      <header className="border-b-2 border-black pb-4 mb-8">
        {data.personal?.image && (
