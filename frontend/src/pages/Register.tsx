...
<div className="lg:w-[50%] bg-slate-100 p-10 sm:p-12 flex flex-col justify-between relative overflow-hidden">
    ...
    <div className="mt-16 relative px-4">
      ...
      <div className="absolute -bottom-4 right-0 z-30 bg-slate-900 text-white text-[10px] font-bold px-3 py-1.5 rounded-full uppercase tracking-[0.2em] shadow-lg">
       {t('optimize_your_job_hunt')}
        ...
        <div className="lg:w-[50%] bg-(--color-card-right) p-10 sm:p-16 flex flex-col justify-center
        ">
          <div className="w-full max-w-sm mx-auto">
            <div className="mb-10">
              <h1 className="text-3xl font-extrabold tracking-tight" style={{ color: 'var(--color-sign-in)' }}>{t('create_account')}</h1>
...
>
  ...
  GitHub
            ...
            <p className="mt-10 text-center text-sm text-slate-500"style={{color:'var(--color-sign-in)'}}>
              {t('already_have_an_account')} <Link to="/login" className="text- font-bold underline">{t('sign_in')}</Link>
            </p>
          </div>
        </div>
      </div>
