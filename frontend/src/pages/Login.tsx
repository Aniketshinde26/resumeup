      ...
      <div className="flex items-center justify-center p-4 sm:p-6 font-sans">    
        ...
        <div className="w-full max-w-7xl flex flex-col">
          <div className="flex flex-col lg:flex-row w-full min-h-[700px] overflow-hidden rounded-[2rem] bg-(--color-card-bg) border border-(--color-border-subtle) shadow-[0_20px_60px_-15px_rgba(0,0,0,0.2)]">        
            ...
            {/* RIGHT SECTION */}
            {/* Added relative, pt-16 to ensure space for the absolute action panel */}
            <div className="lg:w-[50%] bg-(--color-card-right) p-10 pt-16 sm:pt-20 flex flex-col justify-between relative border-r border-(--color-border-subtle)"> 
              ...
              {/* Placed ActionPanel here with absolute layout for perfect corner snapping */}
              <ActionPanel className="absolute top-6 right-6 z-20" />
