...
<div className="lg:w-[50%] bg-(--color-card-right) p-10 flex flex-col justify-between relative border-r border-(--color-border-subtle)">       <div className="w-full max-w-sm mx-auto">
            <div className="mb-10">
...
>
  ...
  GitHub
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center px-1">
                  <label className="text-[10px] font-bold text-slate-00 uppercase tracking-widest">{t('password')}</label>
                  <Link to="/forgot-password" className="text-[10px] text-slate-300 font-bold hover:underline">
                    {t('forgot')}
                  </Link>
                </div>
           ...
           <p className="mt-10 text-center text-sm text-slate-100" style={{ color: 'var(--color-sign-in)' }}>
